...
public class LogUtil {
    ...
    public static final Logger INFO_LOG = LoggerFactory.getLogger("breakFast-info");
    public static final Logger ERROR_LOG = LoggerFactory.getLogger("breakFast-error");
    //    public static final Logger DEBUG_LOG = LoggerFactory.getLogger("breakFast-debug");
    public static final Logger ACCESS_LOG = LoggerFactory.getLogger("breakFast-access");

    public static void logInfo(String message) {
        StringBuilder s = new StringBuilder();
        s.append(getBlock(message));
        INFO_LOG.info(s.toString());
    }
    public static void logDebug(String message) {
        StringBuilder s = new StringBuilder();
        s.append(getBlock(message));
        INFO_LOG.debug(s.toString());
    }
    public static void logError(String message) {
        StringBuilder s = new StringBuilder();
        s.append(getBlock(message));
        INFO_LOG.error(s.toString());
    }
    /**
     * 记录访问日志
