...
public class LogUtil {
    ...
    public static final Logger INFO_LOG = LoggerFactory.getLogger("vmalogo-info");
    public static final Logger ERROR_LOG = LoggerFactory.getLogger("vmalogo-error");
//    public static final Logger DEBUG_LOG = LoggerFactory.getLogger("vmalogo-debug");
    public static final Logger ACCESS_LOG = LoggerFactory.getLogger("vmalogo-access");
