                        ...
                        <div class="row">
                            <form class="form-horizontal" role="form" id="searchForm">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <input op="cn" type="text" class="form-control input-sm" id="questionnaire.qq" name="questionnaire.qq"
                                               placeholder="请输入qq">
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <input op="cn" type="text" class="form-control input-sm" id="questionnaire.cellphone"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <input op="cn" type="text" class="form-control input-sm" id="saleman.name"
                                               name="saleman.name" placeholder="请输入业务员">
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    <label class="col-md-4 search-label"></label>
...
<div class="modal fade" id="perfect" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <form id="perfectForm" method="post" action="${ctx}/order/designPerfect" role="form" enctype="multipart/form-data"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" name="designFile">
                        </div>
                    </div>
...
<div class="modal fade" id="change" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <form id="changeForm" method="post" action="${ctx}/order/changeDesignStatus" role="form"
                  class="form-horizontal">
                <div class="modal-body">
                    <input type="hidden" name="businessOrderId">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="status">
                                <option value="<%=OrderStatus.designing.name()%>"><%=OrderStatus.designing.getName()%>
                                </option>
                                <option value="<%=OrderStatus.designed.name()%>"><%=OrderStatus.designed.getName()%>
                                </option>
                            </select>
                        </div>
                    </div>
...
<script>
    $(function () {
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: "GET",
            height: 'auto',
            colNames: ['编号','logo名', '业务员', '设计师', '客户QQ', '客户手机号', '猪八戒id', '当前状态', '派单时间', '操作'],
            colModel: [
    ...
    function perfect(businessOrderId) {
        $("#perfect [name=businessOrderId]").val(businessOrderId);
        $("#perfect [name=designFile]").val("");
        $('#perfect').modal('show');
    }
    ...
    function makeURLForOperation(cellvalue, options, rowObject) {
        var urlstring = "<div class=\"btn-group\" >" +
                ...
                "<button class=\"btn btn-xs btn-primary\" style=\"margin: 0;margin-left:1px;\"  onclick=\"perfect(" + rowObject["businessOrderId"] + ")\">录入</button>" +
