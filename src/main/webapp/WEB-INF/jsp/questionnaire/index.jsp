<%@ page import="com.trio.vmalogo.enums.LogoComponent" %>
<%@ page import="com.trio.vmalogo.enums.LogoStyle" %>
<%@ page import="com.trio.vmalogo.enums.LogoColor" %>
<%@ page import="com.trio.vmalogo.enums.LogoStartpoint" %>
    ...
    <div id="divContent">
        ...
        <div id="divQuestion">
            <fieldset class='fieldset' style='' id='fieldset1'>
                <form id="questionnaireForm" method="post" action="${ctx}/questionnaire/${username}/generateOrder">

                    <div id="attachmentUrlDiv"></div>
                    <div class='field ui-field-contain' id='div1' req='1' topic='1' data-role='fieldcontain' type='1'>
                        ...
                        <div class='ui-input-text'>
                            <input type='text' id='q1' value='' name='chinese' verify='中文名称'>
                        </div>
                    </div>
                    <div class='field ui-field-contain' req='1' topic='1' data-role='fieldcontain' type='1'>
                        <div class='field-label'>&nbsp;&nbsp;&nbsp;标志(logo)英文名称：</div>
                        <div class='ui-input-text'><input type='text' id='q12' value='' name='english'></div>
                    ...
                    <div class="field ui-field-contain" id="div22" topic="6" data-role="fieldcontain" type="2">
                        ...
                        <div class="ui-input-text"><textarea rows="3" style="max-height:100px;" id="q22"
                                                             name="mainBusiness"
                                                             value=""></textarea></div>
                    ...
                    <div class='field ui-field-contain' id='div33' req='1' topic='5' data-role='fieldcontain' type='3'>
                        ...
                        <div class='ui-controlgroup'>
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio'
                                                                                      value='<%=LogoComponent.english.name()%>'
                                                                                      name='logoComponent' id='q3_1'
                                                                                      style='display:none;' ><a
                                    class='jqradio' href='javascript:;'></a></span><label
                                    for='q3_1'><%=LogoComponent.english.getName()%>
                            </label>
                            </div>
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio'
                                                                                      value='<%=LogoComponent.chinese.name()%>'
                                                                                      name='logoComponent' id='q3_2'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label
                                    for='q3_2'><%=LogoComponent.chinese.getName()%>
                            </label>
                            </div>
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio' id='q3_3'
                                                                                      value='<%=LogoComponent.picture.name()%>'
                                                                                      name='logoComponent'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label
                    ...
                    <div class='field ui-field-contain' id='div43' topic='43' data-role='fieldcontain' type='4'>
                        ...
                        <div class='ui-controlgroup'>
                            <div class='ui-checkbox'><span class='jqcheckwrapper'><input type='checkbox'
                                                                                         value='<%=LogoStyle.professionalSteady.name()%>'
                                                                                         name='logoStyle' id='q44_1'
                                                                                         style='display:none;'><a
                                    class='jqcheck' href='javascript:;'></a></span><label
                                    for='q44_1'><%=LogoStyle.professionalSteady.getName()%>
                            </label></div>
                            <div class='ui-checkbox'><span class='jqcheckwrapper'><input type='checkbox'
                                                                                         value='<%=LogoStyle.fashionDynamic.name()%>'
                                                                                         name='logoStyle' id='q44_2'
                                                                                         style='display:none;'><a
                                    class='jqcheck' href='javascript:;'></a></span><label
                                    for='q44_2'><%=LogoStyle.fashionDynamic.getName()%>
                            </label></div>
                            <div class='ui-checkbox'><span class='jqcheckwrapper'><input type='checkbox'
                                                                                         value='<%=LogoStyle.warmAffinity.name()%>'
                                                                                         name='logoStyle' id='q44_3'
                                                                                         style='display:none;'><a
                                    class='jqcheck' href='javascript:;'></a></span><label
                                    for='q44_3'><%=LogoStyle.warmAffinity.getName()%>
                            </label></div>
                            <div class='ui-checkbox'><span class='jqcheckwrapper'><input type='checkbox'
                                                                                         value='<%=LogoStyle.ethnicFlavor.name()%>'
                                                                                         name='logoStyle' id='q44_4'
                                                                                         style='display:none;'><a
                                    class='jqcheck' href='javascript:;'></a></span><label
                                    for='q44_4'><%=LogoStyle.ethnicFlavor.getName()%>
                            </label></div>
                            <div class='ui-checkbox'><span class='jqcheckwrapper'><input type='checkbox'
                                                                                         value='<%=LogoStyle.internationalStyle.name()%>'
                                                                                         name='logoStyle' id='q44_5'
                                                                                         style='display:none;'><a
                                    class='jqcheck' href='javascript:;'></a></span><label
                            ...
                            <div class='ui-checkbox'><span class='jqcheckwrapper'><input type='checkbox'
                                                                                         value='<%=LogoStyle.freshNatural.name()%>'
                                                                                         name='logoStyle' id='q44_6'
                                                                                         style='display:none;'><a
                                    class='jqcheck' href='javascript:;'></a></span><label
                                    for='q44_6'><%=LogoStyle.freshNatural.getName()%>
                            </label></div>
                            <div class='ui-checkbox'><span class='jqcheckwrapper'><input type='checkbox'
                                                                                         value='<%=LogoStyle.TraditionalOldShop.name()%>'
                                                                                         name='logoStyle' id='q44_7'
                                                                                         style='display:none;'><a
                                    class='jqcheck' href='javascript:;'></a></span><label
                    ...
                    <div class='field ui-field-contain' id='div45' topic='49' data-role='fieldcontain' type='3'>
                        ...
                        <div class='ui-controlgroup'>
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio'
                                                                                      value='<%=LogoColor.cool.name()%>'
                                                                                      name='logoColor' id='q45_1'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label for='q45_1'>
                                <div class="boxs">
                            ...
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio'
                                                                                      value='<%=LogoColor.warm.name()%>'
                                                                                      name='logoColor' id='q45_2'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label for='q45_2'>
                                <div class="boxs">
                            ...
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio'
                                                                                      value='<%=LogoColor.neutral.name()%>'
                                                                                      name='logoColor' id='q45_3'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label for='q45_3'>
                                <div class="boxs">
                    ...
                    <div class='field ui-field-contain' id='div75' topic='79' data-role='fieldcontain' type='3'>
                        ...
                        <div class='ui-controlgroup'>
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio' value='true'
                                                                                      name='colourForbid' id='q62_1'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label for='q62_1'>限制颜色</label>

                                <div class='ui-text'><input type='text' rel='q4_5' name="colourForbidDetail"
                                                            placeholder="此处请填入您禁忌的颜色"
                                                            class='OtherText'></div>
                                <br/></div>
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio' value='false'
                                                                                      name='colourForbid' id='q62_2'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label
                    ...
                    <div class='field ui-field-contain' id='div46' topic='59' type='3'>
                        ...
                        <div class='ui-controlgroup'>
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio'
                                                                                      value='<%=LogoStartpoint.brandName.name()%>'
                                                                                      name='logoStartpoint' id='q46_1'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label for='q46_1'>
                                <div class="boxs">
                            ...
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio'
                                                                                      value='<%=LogoStartpoint.industryCharacteristics.name()%>'
                                                                                      name='logoStartpoint' id='q46_2'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label for='q46_2'>
                                <div class="boxs">
                            ...
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio'
                                                                                      value='<%=LogoStartpoint.outstandingIdea.name()%>'
                                                                                      name='logoStartpoint' id='q46_3'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label for='q46_3'>
                                <div class="boxs">
                            ...
                            <div class='ui-radio'><span class='jqradiowrapper'><input type='radio'
                                                                                      value='<%=LogoStartpoint.others.name()%>'
                                                                                      name='logoStartpoint' id='q46_4'
                                                                                      style='display:none;'><a
                                    class='jqradio' href='javascript:;'></a></span><label
                                    for='q46_4'><%=LogoStartpoint.others.getName()%>
                            </label>

                                <div class='ui-text'><input type='text' rel='q4_5' name="logoStartpointdetail"
                                                            placeholder="如果有指定，请填写"
                                                            class='OtherText'></div>
                                <br/></div>
                    ...
                    <div class='field ui-field-contain' id='div2' req='1' topic='2' data-role='fieldcontain' type='1'>
                        ...
                        <div class='ui-input-text'><input type='number' pattern='[0-9]*' id='q2' value=''
                                                          name='cellphone'
                                                          verify='手机'></div>
                    </div>
                    <div class='field ui-field-contain' req='1' topic='2' data-role='fieldcontain' type='1'>
                        ...
                        <div class='ui-input-text'><input type='number' pattern='[0-9]*' id='q3' value='' name='qq'
                                ></div>
                    ...
                    <div class="field ui-field-contain" id="div24" topic="26" data-role="fieldcontain" type="2">
                        ...
                        <div class="ui-input-text"><textarea rows="3" style="max-height:100px;" id="q26" name="others"
                                                             value=""></textarea></div>
                        <div class="errorMessage"></div>
                    </div>
                </form>
        ...
        <div class="footer">
            ...
            <div id="divSubmit" style="padding: 10px; display:none;">
                ...
                <button id="submit" type="button" class="button blue">
                    提交
                </button>
...
<script>
    $(function () {
        $('input:radio[name=logoComponent]:eq(0)').prop("checked", "checked");
        $('input:radio[name=logoComponent]:eq(0)').parent().find("a").addClass("jqchecked");
            ...
            submitHandler: function (form) {
                ...
                $(form).ajaxSubmit({
                    success: function (json) {
                        if (json.success) {
                            window.location.href="${ctx}/questionnaire/result";
                        }else {
                            bootbox.dialog({
