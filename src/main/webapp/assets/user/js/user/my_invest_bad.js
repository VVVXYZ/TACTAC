+function ($) {
    $(function () {
        var table_selector = "#bad_debt_table";
        $(table_selector).dataTable( {
            ...
            "processing": true,
            "serverSide": true,
            "sAjaxSource": path + "/client/myInvestment/webPlConditionQuery/bad",
    ...
    $(function () {
        var table_selector = "#hxBad_debt_table";
        $(table_selector).dataTable({
            "language": { // 汉化
                "processing": "正在加载数据...",
                "lengthMenu": "每页显示 _MENU_ 条 ",
            ...
            "processing": true,
            "serverSide": true,
            "sAjaxSource": path + "/client/myInvestment/webHxConditionQuery/bad",
            "dom": "t<'row'<'col-sm-5'i><'col-sm-7'p>>",
            "paginationType": "full_numbers",
            "columns": [
                {
