    ...
    $(function () {
        ...
        $(table_selector).dataTable({
            ...
            "serverData": function (source, data, callback) {
                ...
                var loadRecordId = $("#loadRecordId").val();
                var params = new Object();
                params["loadRecordId"] = loadRecordId;
                ...
                $.ajax({
                    ...
                    "success": function (resp) {
                        ...
                        console.log("params=" + params["loadRecordId"]);
                    }
                });
            },
            ...
            "processing": true,
            "serverSide": true,
            "sAjaxSource": path + "/client/myInvestment/repaymentPlan",
            ...
            "columns": [
                ...
                {"data": "repayTotal", "name": "repayTotal", 'sClass': '', "bSortable": true},
