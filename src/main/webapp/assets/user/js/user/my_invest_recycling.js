+function ($) {
    $(function () {
        var table_selector = "#recycling_project_table";
        $(table_selector).dataTable( {
            ...
            "processing": true,
            "serverSide": true,
            "sAjaxSource": path + "/client/myInvestment/webPlConditionQuery/repaying",
    ...
    $(function () {
        var table_selector = "#hxRecycling_project_table";
        $(table_selector).dataTable({
            "language": { // 汉化
                "processing": "正在加载数据...",
                "lengthMenu": "每页显示 _MENU_ 条 ",
            ...
            "processing": true,
            "serverSide": true,
            "sAjaxSource": path + "/client/myInvestment/webHxConditionQuery/repaying",
            "dom": "t<'row'<'col-sm-5'i><'col-sm-7'p>>",
            "paginationType": "full_numbers",
            "columns": [
                {
