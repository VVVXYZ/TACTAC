define("echarts/chart/map", ["require", "./base", "zrender/shape/Text", "zrender/shape/Path", "zrender/shape/Circle", "zrender/shape/Rectangle", "zrender/shape/Line", "zrender/shape/Polygon", "zrender/shape/Ellipse", "zrender/shape/Image", "../component/dataRange", "../component/roamController", "../layer/heatmap", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/event", "../util/mapData/params", "../util/mapData/textFixed", "../util/mapData/geoCoord", "../util/projection/svg", "../util/projection/normal", "../chart"], function (e) {
    ...
    var i = e("./base"), n = e("zrender/shape/Text"), a = e("zrender/shape/Path"), o = e("zrender/shape/Circle"), r = e("zrender/shape/Rectangle"), s = e("zrender/shape/Line"), l = e("zrender/shape/Polygon"), h = e("zrender/shape/Ellipse"), m = e("zrender/shape/Image");
    e("../component/dataRange"), e("../component/roamController");
    var V = e("../layer/heatmap"), U = e("../config");
    U.map = {
        zlevel: 0,
        z: 2,
        mapType: "china",
    ...
    var d = e("../util/ecData"), p = e("zrender/tool/util"), c = e("zrender/config"), u = e("zrender/tool/event"), y = e("../util/mapData/params").params, g = e("../util/mapData/textFixed"), b = e("../util/mapData/geoCoord");
    return t.prototype = {
        type: U.CHART_TYPE_MAP, _buildShape: function () {
            var e = this.series;
            ...
            for (var i = e.replace(/^.*\|/, ""), n = t.features, a = 0, o = n.length; o > a; a++)if (n[a].properties && n[a].properties.name == i) {
                n = n[a], "United States of America" == i && n.geometry.coordinates.length > 1 && (n = {
                    ...
                    }, id: n.id, properties: n.properties, type: n.type
                });
                break
            }
            return {type: "FeatureCollection", features: [n]}
        }, _getProjectionData: function (e, t, i) {
            var n, a = this._mapDataMap[e].projection, o = [], r = this._mapDataMap[e].bbox || a.getBbox(t, this._specialArea[e]);
            ...
            if (this._specialArea[e])for (var U in this._specialArea[e])o.push(this._getSpecialProjectionData(e, t, U, this._specialArea[e][U], h));
            if ("china" == e) {
                var d = this.geo2pos(e, b["南海诸岛"] || y["南海诸岛"].textCoord), c = n.scale.x / 10.5, u = [32 * c + d[0], 83 * c + d[1]];
            ...
            var r = e("../util/projection/normal"), s = r.getBbox(i), l = this.geo2pos(t, [a.left, a.top]), h = this.geo2pos(t, [a.left + a.width, a.top + a.height]), m = Math.abs(h[0] - l[0]), V = Math.abs(h[1] - l[1]), U = s.width, d = s.height, p = m / .75 / U, c = V / d;
            p > c ? (p = .75 * c, m = U * p) : (c = p, p = .75 * c, V = d * c);
            var u = {OffsetLeft: l[0], OffsetTop: l[1], scale: {x: p, y: c}}, y = r.geoJson2Path(i, u);
            return this._getSingleProvince(t, y[0], o)
        }, _getSingleProvince: function (e, t, i) {
            var n, a = t.properties.name, o = g[a] || [0, 0];
            if (b[a])n = this.geo2pos(e, b[a]); else if (t.cp)n = [t.cp[0] + o[0], t.cp[1] + o[1]]; else {
            ...
            var n, a, o, r, s, l, h, m = this.series, V = this.zr.getWidth(), U = this.zr.getHeight(), d = Math.round(.02 * Math.min(V, U));
            ...
            var c = e.width, u = e.height, y = l / i / c, g = h / u;
            ...
            for (var V, c, u, y, g, b, f, k, _, x, L, W = this.series, X = this.component.legend, v = this.component.dataRange, K = 0, w = t.length; w > K; K++) {
                if (k = p.clone(t[K]), _ = {
                        name: k.name,
                        path: k.path,
                    ...
                    for (var I = 0, J = u.seriesIndex.length; J > I; I++) {
                        ...
                        g.push(C), V += C.name + " ", X && this._showLegendSymbol[e] && X.hasColor(C.name) && this.shapeList.push(new o({
                            ...
                            position: p.clone(k.position),
                            _mapType: e,
                            style: {x: k.textX + 3 + 7 * I, y: k.textY - 10, r: 3, color: X.getColor(C.name)},
                            hoverable: !1
                        }))
                    }
                    y = u.value
                ...
                switch (this.ecTheme.map && g.push(this.ecTheme.map), g.push(U.map), b = v && !isNaN(y) ? v.getColor(y) : null, k.color = k.color || b || this.getItemStyleColor(this.deepQuery(g, "itemStyle.normal.color"), u.seriesIndex, -1, u) || this.deepQuery(g, "itemStyle.normal.areaStyle.color"), k.strokeColor = k.strokeColor || this.deepQuery(g, "itemStyle.normal.borderColor"), k.lineWidth = k.lineWidth || this.deepQuery(g, "itemStyle.normal.borderWidth"), _.color = this.getItemStyleColor(this.deepQuery(g, "itemStyle.emphasis.color"), u.seriesIndex, -1, u) || this.deepQuery(g, "itemStyle.emphasis.areaStyle.color") || k.color, _.strokeColor = this.deepQuery(g, "itemStyle.emphasis.borderColor") || k.strokeColor, _.lineWidth = this.deepQuery(g, "itemStyle.emphasis.borderWidth") || k.lineWidth, k.brushType = _.brushType = k.brushType || "both", k.lineJoin = _.lineJoin = "round", k._name = _._name = c, f = this.deepQuery(g, "itemStyle.normal.label.textStyle"), L = {
                ...
                }, L._style = p.clone(L.style), L.highlightStyle = p.clone(L.style), this.deepQuery(g, "itemStyle.emphasis.label.show") ? (L.highlightStyle.text = this.getLabelText(c, y, g, "emphasis"), L.highlightStyle.color = this.deepQuery(g, "itemStyle.emphasis.label.textStyle.color") || L.style.color, f = this.deepQuery(g, "itemStyle.emphasis.label.textStyle") || f, L.highlightStyle.textFont = this.getFont(f)) : L.highlightStyle.color = "rgba(0,0,0,0)", x = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    position: p.clone(k.position),
                    style: k,
                    ...
                    _style: p.clone(k),
                    _mapType: e
                }, null != k.scale && (x.scale = p.clone(k.scale)), L = new n(L), x.style.shapeType) {
                    case"rectangle":
                        x = new r(x);
                        break;
                    case"line":
                    ...
                    case"ellipse":
                        ...
                        break;
                    default:
                        x = new a(x), x.buildPathArray && (x.style.pathArray = x.buildPathArray(x.style.path))
                }
                (this._selectedMode[e] && this._selected[c] && u.selected !== !1 || u.selected === !0) && (L.style = L.highlightStyle, x.style = x.highlightStyle), L.clickable = x.clickable = this._clickable[e] && (null == u.clickable || u.clickable), this._selectedMode[e] && (this._selected[c] = null != this._selected[c] ? this._selected[c] : u.selected, this._mapTypeMap[c] = e, (null == u.selectable || u.selectable) && (x.clickable = L.clickable = !0, x.onclick = L.onclick = this.shapeHandler.onclick)), this._hoverable[e] && (null == u.hoverable || u.hoverable) ? (L.hoverable = x.hoverable = !0, x.hoverConnect = L.id, L.hoverConnect = x.id) : L.hoverable = x.hoverable = !1, d.pack(L, {
                    name: V,
                    tooltip: this.deepQuery(g, "tooltip")
                }, 0, u, 0, c), this.shapeList.push(L), d.pack(x, {
                    name: V,
                    tooltip: this.deepQuery(g, "tooltip")
                }, 0, u, 0, c), this.shapeList.push(x)
            }
            ...
            for (var t = this.series, i = 0, n = t.length; n > i; i++)if (t[i].heatmap) {
                ...
                var d = new V(t[i].heatmap), p = d.getCanvas(a[0][3] ? o : a, this.zr.getWidth(), this.zr.getHeight()), c = new m({
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase() + 1,
                    position: l,
                    scale: [1, 1],
                    hoverable: !1,
                    style: {x: 0, y: 0, image: p, width: p.width, height: p.height}
                });
            ...
            var i, n, a, o, r;
            for (var s in this._mapDataMap)if (i = this._mapDataMap[s].transform, i && this._roamMap[s] && this._activeMapType[s] && (n = i.left, a = i.top, o = i.width, r = i.height, e >= n && n + o >= e && t >= a && a + r >= t))return s
            ...
            if (!(this.shapeList.length <= 0)) {
                ...
                var r, s, l = e.event, h = u.getX(l), m = u.getY(l), V = u.getDelta(l), d = e.mapTypeControl;
                d || (d = {}, s = this._findMapTypeByPos(h, m), s && this._roamMap[s] && "move" != this._roamMap[s] && (d[s] = !0));
                var p = !1;
                for (s in d)if (d[s]) {
                    p = !0;
                    var c = this._mapDataMap[s].transform, y = c.left, g = c.top, b = c.width, f = c.height, k = this.pos2geo(s, [h - y, m - g]);
                    if (V > 0) {
                    ...
                    for (var n = 0, a = this.shapeList.length; a > n; n++) {
                        var o = this.shapeList[n];
                        if (o._mapType == s) {
                            var _ = o.type, x = o.style;
                            switch (o.position[0] = c.left, o.position[1] = c.top, _) {
                                case"path":
                                case"symbol":
                                case"circle":
                                case"rectangle":
                                ...
                                case"polyline":
                                    ...
                                    break;
                                case"shape-bundle":
                                    for (var L = 0; L < x.shapeList.length; L++) {
                                        var W = x.shapeList[L];
                                ...
                                case"icon":
                                case"image":
                                    k = this.geo2pos(s, o._geo), x.x = x._x = k[0] - x.width / 2, x.y = x._y = k[1] - x.height / 2;
                                    break;
                                default:
                                    k = this.geo2pos(s, o._geo), x.x = k[0], x.y = k[1], "text" == _ && (o._style.x = o.highlightStyle.x = k[0], o._style.y = o.highlightStyle.y = k[1])
                            }
                ...
                if (p) {
                    ...
                    }, 100), this.messageCenter.dispatch(U.EVENT.MAP_ROAM, e.event, {type: "scale"}, this.myChart)
                }
            }
            ...
            if (!(this.shapeList.length <= 0)) {
                var t = e.target;
                if (!t || !t.draggable) {
                    var i = e.event, n = u.getX(i), a = u.getY(i), o = this._findMapTypeByPos(n, a);
            ...
            if (this._mousedown && this._isAlive) {
                var t = e.event, i = u.getX(t), n = u.getY(t), a = this._mapDataMap[this._curMapType].transform;
                ...
                this.messageCenter.dispatch(U.EVENT.MAP_ROAM, e.event, {type: "move"}, this.myChart), this.clearEffectShape(!0), this.zr.refreshNextFrame(), this._justMove = !0, u.stop(t)
            }
            ...
            var i = e.mapTypeControl, n = 0, a = 0, o = e.step;
            switch (e.roamType) {
                case"scaleUp":
            ...
            this.messageCenter.dispatch(U.EVENT.MAP_ROAM, e.event, {type: "move"}, this.myChart), this.clearEffectShape(!0), this.zr.refreshNextFrame(), clearTimeout(this.dircetionTimer);
            var m = this;
            ...
            if (this.isClick && e.target && !this._justMove && "icon" != e.target.type) {
                this.isClick = !1;
                var t = e.target, i = t.style._name, n = this.shapeList.length, a = t._mapType || "";
    ...
    return s.prototype = {
        type: "path", buildPathArray: function (e, t, i) {
            if (!e)return [];
            t = t || 0, i = i || 0;
            var a = e, o = ["m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S", "a", "A"];
            ...
            var V = m * (Math.PI / 180), U = Math.cos(V) * (e - i) / 2 + Math.sin(V) * (t - n) / 2, d = -1 * Math.sin(V) * (e - i) / 2 + Math.cos(V) * (t - n) / 2, p = U * U / (l * l) + d * d / (h * h);
            p > 1 && (l *= Math.sqrt(p), h *= Math.sqrt(p));
            var c = Math.sqrt((l * l * h * h - l * l * d * d - h * h * U * U) / (l * l * d * d + h * h * U * U));
            a === s && (c *= -1), isNaN(c) && (c = 0);
            var u = c * l * d / h, y = c * -h * U / l, g = (e + i) / 2 + Math.cos(V) * u - Math.sin(V) * y, b = (t + n) / 2 + Math.sin(V) * u + Math.cos(V) * y, f = r([1, 0], [(U - u) / l, (d - y) / h]), k = [(U - u) / l, (d - y) / h], _ = [(-1 * U - u) / l, (-1 * d - y) / h], x = r(k, _);
            ...
            for (var l = 0, h = o.length; h > l; l++) {
                ...
                switch (d) {
                    ...
                    case"Q":
                        ...
                        break;
                    case"A":
                        var p = m[0], c = m[1], u = m[2], y = m[3], g = m[4], b = m[5], f = m[6], k = m[7], _ = u > y ? u : y, x = u > y ? 1 : u / y, L = u > y ? y / u : 1;
    ...
    return i.prototype = {
        type: "ellipse", buildPath: function (e, t) {
            var i = .5522848, n = t.x, a = t.y, o = t.a, r = t.b, s = o * i, l = r * i;
    ...
    var i = e("./base"), n = e("zrender/shape/Text"), a = e("zrender/shape/Rectangle"), o = e("../util/shape/HandlePolygon"), r = e("../config");
    r.dataRange = {
        zlevel: 0,
        z: 4,
        show: !0,
    ...
    var s = e("zrender/tool/util"), l = e("zrender/tool/event"), h = e("zrender/tool/area"), m = e("zrender/tool/color");
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATARANGE, _textGap: 10, _buildShape: function () {
            ...
            var e, t, i, o, r = this._valueTextList, s = r.length, l = this.getFont(this.dataRangeOption.textStyle), m = this._itemGroupLocation.x, V = this._itemGroupLocation.y, U = this.dataRangeOption.itemWidth, d = this.dataRangeOption.itemHeight, p = this.dataRangeOption.itemGap, c = h.getTextHeight("国", l);
            ...
            var t, i, o = this.getFont(this.dataRangeOption.textStyle), r = this._itemGroupLocation.x, s = this._itemGroupLocation.y, l = this.dataRangeOption.itemWidth, m = this.dataRangeOption.itemHeight, V = h.getTextHeight("国", o), U = 10, d = !0;
            ...
            "horizontal" == this.dataRangeOption.orient ? (t = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {x: r, y: s, width: l * U, height: m, color: p.getLinearGradient(r, s, r + l * U, s, u)},
                hoverable: !1
            }, r += l * U + this._textGap) : (t = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {x: r, y: s, width: l, height: m * U, color: p.getLinearGradient(r, s, r, s + m * U, u)},
                hoverable: !1
            ...
            var e, t, i = this._calculableLocation.x, n = this._calculableLocation.y, a = this._calculableLocation.width, r = this._calculableLocation.height, s = 5;
            "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (e = [[i, n + r], [i - s, n + r + s], [i + s, n + r + s]], t = "bottom") : (e = [[i, n], [i - s, n - s], [i + s, n - s]], t = "top") : "right" != this.dataRangeOption.x ? (e = [[i + a, n], [i + a + s, n - s], [i + a + s, n + s]], t = "right") : (e = [[i, n], [i - s, n - s], [i - s, n + s]], t = "left"), this._indicatorShape = {
                style: {
                    pointList: e,
                    color: "#fff",
                    __rect: {
            ...
            var e, t, i, n, a, r, s, l, m = this._calculableLocation.x, V = this._calculableLocation.y, U = this._calculableLocation.width, d = this._calculableLocation.height, p = this.getFont(this.dataRangeOption.textStyle), c = h.getTextHeight("国", p), u = Math.max(h.getTextWidth(this._textFormat(this.dataRangeOption.max), p), h.getTextWidth(this._textFormat(this.dataRangeOption.min), p)) + 2;
            "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (e = [[m, V], [m, V + d + c], [m - c, V + d + c], [m - 1, V + d], [m - 1, V]], t = m - u / 2 - c, i = V + d + c / 2 + 2, n = {
                x: m - u - c,
                y: V + d,
                width: u + c,
                height: c
            }, a = [[m + U, V], [m + U, V + d + c], [m + U + c, V + d + c], [m + U + 1, V + d], [m + U + 1, V]], r = m + U + u / 2 + c, s = i, l = {
                x: m + U,
                y: V + d,
                width: u + c,
                height: c
            }) : (e = [[m, V + d], [m, V - c], [m - c, V - c], [m - 1, V], [m - 1, V + d]], t = m - u / 2 - c, i = V - c / 2 - 2, n = {
                x: m - u - c,
                y: V - c,
                width: u + c,
                height: c
            }, a = [[m + U, V + d], [m + U, V - c], [m + U + c, V - c], [m + U + 1, V], [m + U + 1, V + d]], r = m + U + u / 2 + c, s = i, l = {
                x: m + U,
                y: V - c,
                width: u + c,
                height: c
            }) : (u += c, "right" != this.dataRangeOption.x ? (e = [[m, V], [m + U + c, V], [m + U + c, V - c], [m + U, V - 1], [m, V - 1]], t = m + U + u / 2 + c / 2, i = V - c / 2, n = {
                x: m + U,
                y: V - c,
                width: u + c,
                height: c
                ...
                width: u + c,
                height: c
            }) : (e = [[m + U, V], [m - c, V], [m - c, V - c], [m, V - 1], [m + U, V - 1]], t = m - u / 2 - c / 2, i = V - c / 2, n = {
                x: m - u - c,
                y: V - c,
                width: u + c,
                height: c
            ...
            var e = this._valueTextList, t = e.length, i = this.dataRangeOption.itemGap, n = this.dataRangeOption.itemWidth, a = this.dataRangeOption.itemHeight, o = 0, r = 0, s = this.getFont(this.dataRangeOption.textStyle), l = h.getTextHeight("国", s), m = 10;
            ...
            var d, p = this.reformCssArray(this.dataRangeOption.padding), c = this.zr.getWidth();
            ...
            var n = this._calculableLocation.x, a = this._calculableLocation.y, o = this._calculableLocation.width, r = this._calculableLocation.height;
            ...
            var e = this.dataRangeOption.range || {}, t = e.start, i = e.end;
            ...
            var t, i, n = this._calculableLocation.x, a = this._calculableLocation.y, o = this._calculableLocation.width, r = this._calculableLocation.height;
            ...
            if (this._useCustomizedSplit())for (var o = this._splitList, a = 0, t = o.length; t > a; a++)o[a].color && (this._colorList[a] = o[a].color)
            ...
            var t;
            if (this._useCustomizedSplit()) {
                for (var i = this._splitList, n = 0, a = i.length; a > n; n++)if (i[n].min <= e && i[n].max >= e) {
                    t = n;
                    break
                }
            } else {
    ...
    var i = e("./base"), n = e("zrender/shape/Rectangle"), a = e("zrender/shape/Sector"), o = e("zrender/shape/Circle"), r = e("../config");
    r.roamController = {
        zlevel: 0,
        z: 4,
        show: !0,
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_ROAMCONTROLLER, _buildShape: function () {
            ...
            var t = this._itemGroupLocation.r, i = this._itemGroupLocation.x + t, n = this._itemGroupLocation.y + t, o = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
                    x: i,
            ...
            var t = this._itemGroupLocation.width, i = this._itemGroupLocation.height - t;
            i = 0 > i ? 20 : i;
            var n = Math.min(t / 2 - 5, i) / 2, a = this._itemGroupLocation.x + ("scaleDown" === e ? t - n : n), r = this._itemGroupLocation.y + this._itemGroupLocation.height - n, s = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
                    x: a,
            ...
            var e, t = this.reformCssArray(this.rcOption.padding), i = this.rcOption.width, n = this.rcOption.height, a = this.zr.getWidth(), o = this.zr.getHeight();
    ...
    return e.prototype = {
        getCanvas: function (e, t, a) {
            ...
            for (var h = l.getContext("2d"), m = e.length, V = 0; m > V; ++V) {
                var U = e[V], d = U[0], p = U[1], c = U[2], u = Math.min(1, Math.max(c * this.option.valueScale || this.option.minAlpha, this.option.minAlpha));
                h.globalAlpha = u, h.drawImage(o, d - s, p - s)
            }
            for (var y = h.getImageData(0, 0, l.width, l.height), g = y.data, m = g.length / 4; m--;) {
                var b = 4 * m + 3, u = g[b] / 256, f = Math.floor(u * (n - 1));
    ...
    function t(e) {
        ...
        for (var t = e.features, n = 0; n < t.length; n++)for (var a = t[n], o = a.geometry.coordinates, r = a.geometry.encodeOffsets, s = 0; s < o.length; s++) {
            var l = o[s];
            if ("Polygon" === a.geometry.type)o[s] = i(l, r[s]); else if ("MultiPolygon" === a.geometry.type)for (var h = 0; h < l.length; h++) {
                var m = l[h];
                l[h] = i(m, r[s][h])
            }
        }
    ...
    function i(e) {
        for (var i = e.firstChild; "svg" != i.nodeName.toLowerCase() || 1 != i.nodeType;)i = i.nextSibling;
        var n = t(i.getAttribute("x")), a = t(i.getAttribute("y")), o = t(i.getAttribute("width")), r = t(i.getAttribute("height"));
    ...
    function s(e, t) {
        var i = t.getAttribute("fill"), n = t.getAttribute("stroke"), a = t.getAttribute("stroke-width"), o = t.getAttribute("opacity");
    ...
    function l(e) {
        for (var t = r(e).replace(/,/g, " ").split(/\s+/), i = [], n = 0; n < t.length;) {
            var a = parseFloat(t[n++]), o = parseFloat(t[n++]);
            i.push([a, o])
        }
        return i
    }

    var h = e("zrender/shape/Path"), m = {
        path: function (e, t) {
            var i = e.getAttribute("d"), n = h.prototype.getRect({path: i});
            return {shapeType: "path", path: i, cp: [(n.x + n.width / 2) * t[0], (n.y + n.height / 2) * t[1]]}
        }, rect: function (e, i) {
            var n = t(e.getAttribute("x")), a = t(e.getAttribute("y")), o = t(e.getAttribute("width")), r = t(e.getAttribute("height"));
            return {
                shapeType: "rectangle",
                x: n,
                y: a,
            ...
            var n = t(e.getAttribute("x1")), a = t(e.getAttribute("y1")), o = t(e.getAttribute("x2")), r = t(e.getAttribute("y2"));
            return {
                shapeType: "line",
                xStart: n,
                yStart: a,
            ...
            var n = t(e.getAttribute("cx")), a = t(e.getAttribute("cy")), o = t(e.getAttribute("r"));
            return {shapeType: "circle", x: n, y: a, r: o, cp: [n * i[0], a * i[1]]}
        }, ellipse: function (e, t) {
            var i = parseFloat(e.getAttribute("cx") || 0), n = parseFloat(e.getAttribute("cy") || 0), a = parseFloat(e.getAttribute("rx") || 0), o = parseFloat(e.getAttribute("ry") || 0);
            return {shapeType: "ellipse", x: i, y: n, a: a, b: o, cp: [i * t[0], n * t[1]]}
        }, polygon: function (e, t) {
            var i = e.getAttribute("points"), n = [1 / 0, 1 / 0], a = [-(1 / 0), -(1 / 0)];
            if (i) {
                i = l(i);
    ...
    function t(e, t) {
        ...
        for (var i, n, a = e.features, o = 0, s = a.length; s > o; o++)if (n = a[o], !n.properties.name || !t[n.properties.name])switch (n.type) {
            case"Feature":
    ...
    function i(e, i, n) {
        ...
        for (var r, s, l, h = e.features, m = [], V = 0, U = h.length; U > V; V++)if (l = h[V], !l.properties.name || !n[l.properties.name])if ("Feature" == l.type)a(l.geometry, l); else if ("GeometryCollection" == l.type) {
            r = l.geometries;
    ...
    var o = {
        formatPoint: function (e) {
            ...
            var n = (i[0] - o.offset.x) * o.scale.x + o.offset.left, a = (i[1] - o.offset.y) * o.scale.y + o.offset.top;
            return [n, a]
        }, Point: function (e) {
        ...
        formatPoint: o.formatPoint, makePoint: function (e) {
            var t = this, i = t.formatPoint(e), n = i[0], a = i[1];
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "he_nan", properties: {name: "河南", cp: [113.4668, 33.8818], childNum: 17},
            geometry: {
                type: "Polygon",
    ...
    return {
        type: "FeatureCollection", features: [{
            type: "Feature", id: "4418", properties: {name: "清远市", cp: [112.9175, 24.3292], childNum: 8}, geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "469027", properties: {name: "澄迈县", cp: [109.9937, 19.7314], childNum: 1}, geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "4203", properties: {name: "十堰市", cp: [110.5115, 32.3877], childNum: 9}, geometry: {
                type: "MultiPolygon",
    ...
    return {
        ...
        features: [{
            ...
            id: "3601",
            properties: {
                name: "南昌市", cp: [116.0046, 28.6633], childNum: 6
            },
            geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "310116", properties: {name: "金山区", cp: [121.2657, 30.8112], childNum: 1}, geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "GMB", properties: {name: "Gambia"}, geometry: {
                type: "Polygon", coordinates: ["@@ņόࣶzȎȦˊ`ͨȷʼIˢƚǞʏεȋιdέǰ̷ȗƭQȫŝއl"], encodeOffsets: [[-17245, 13468]]
            }
        }, {
            type: "Feature",
            id: "GNB",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "6531", properties: {name: "喀什地区", cp: [77.168, 37.8534], childNum: 13}, geometry: {
                type: "Polygon",
