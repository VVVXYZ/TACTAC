define("echarts/chart/force", ["require", "./base", "../data/Graph", "../layout/Force", "zrender/shape/Line", "zrender/shape/BezierCurve", "zrender/shape/Image", "../util/shape/Icon", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/vector", "../chart"], function (e) {
    ...
    var u = e("../util/ecData"), g = e("zrender/tool/util"), y = e("zrender/config"), f = e("zrender/tool/vector");
    return t.prototype = {
        constructor: t, type: m.CHART_TYPE_FORCE, _init: function () {
            this.selectedMap = {};
            var e, t = this.component.legend, i = this.series;
            this.clear();
            ...
            var i = e.roam === !0 || "move" === e.roam, n = e.roam === !0 || "scale" === e.roam;
            ...
            for (var o = e.data || e.nodes, a = 0; a < o.length; a++) {
                ...
                if (this.selectedMap[c] = this.isSelected(c), this.selectedMap[c])t.push(r), i++; else {
                    n.splice(i, 1);
            ...
            for (var n = 0, a = e.links.length; a > n; n++) {
                var d = e.links[n], c = d.source, p = d.target;
            ...
            var t = this._graph, i = t.nodes.length, n = this.query(e, "minRadius"), a = this.query(e, "maxRadius");
            ...
            for (var h = 0; i > h; h++) {
                ...
                var u = d.shape.style, g = d.layout.size;
            ...
            var i = this._graph, n = this.query(e, "categories");
            i.eachNode(function (i) {
                var a = this._getNodeCategory(e, i.data), o = [i.data, a, e], r = this._getNodeQueryTarget(e, i.data), s = this._getNodeQueryTarget(e, i.data, "emphasis"), l = new p({
                    style: {
                        x: 0,
                        y: 0,
            ...
            for (var i = this._graph, n = i.edges.length, a = 0; n > a; a++) {
                var o = i.edges[a], r = o.data, s = o.node1, l = o.node2, c = i.getEdge(l, s), m = this._getEdgeQueryTarget(e, r), y = this.deepQuery(m, "type");
                e.linkSymbol && "none" !== e.linkSymbol && (y = "line");
                var f = "line" === y ? h : d, V = new f({
            ...
            for (var e = f.create(), t = f.create(), i = f.create(), n = f.create(), a = this._graph.edges, o = 0, r = a.length; r > o; o++) {
                var s = a[o], l = s.node1.shape, h = s.node2.shape;
            ...
            for (var e = this._graph, t = 0; t < e.nodes.length; t++) {
                var i = e.nodes[t], n = i.layout.position, a = i.data, o = i.shape, r = o.fixed || a.fixX, s = o.fixed || a.fixY;
    ...
    i.prototype.isDirected = function () {
        ...
        if ("string" == typeof t && (t = this._nodesMap[t]), t) {
            ...
            if (!e.call(n, t, null))for (var r = [t]; r.length;)for (var s = r.shift(), l = s[a], o = 0; o < l.length; o++) {
    ...
    var i, n = e("./forceLayoutWorker"), a = e("zrender/tool/vector"), o = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function (e) {
            setTimeout(e, 16)
        ...
        var n = this, a = this._$onupdate;
        this._$onupdate = function (e) {
            a.call(n, e)
        }
    };
    return s.prototype.updateConfig = function () {
        var e = this.width, t = this.height, i = Math.min(e, t), n = {
            center: this.center,
        ...
        if (this._layoutWorker)this._layoutWorker.postMessage({
            cmd: "updateConfig",
            config: n
        }); else for (var a in n)this._layout[a] = n[a]
    ...
    if (i.prototype.beforeUpdate = function () {
            ...
            var t = this.findSubRegion(e.position[0], e.position[1]), i = this.bbox;
            if (!t) {
                var n = (i[0] + i[2]) / 2, a = (i[1] + i[3]) / 2, o = (i[2] - i[0]) / 2, r = (i[3] - i[1]) / 2, s = e.position[0] >= n ? 1 : 0, l = e.position[1] >= a ? 1 : 0, t = this._newSubRegion();
            ...
            var t = this.centerOfMass[0] * this.mass, i = this.centerOfMass[1] * this.mass;
            ...
            if (this.updateBBox(), this._k = .4 * this.scaling * Math.sqrt(this.width * this.height / e), this.barnesHutOptimize) {
                ...
                var i = 0, n = this._rootRegion.centerOfMass;
                r.set(n, 0, 0);
                for (var t = 0; e > t; t++) {
                    var a = this.nodes[t];
            ...
            for (var e = this.nodes.length, t = r.create(), i = 0; e > i; i++) {
                var n = this.nodes[i], a = n.speed;
                r.scale(n.force, n.force, 1 / 30);
                var o = r.len(n.force) + .1, s = Math.min(o, 500) / o;
                ...
                var d = r.len(a), s = Math.min(d, 100) / (d + .1);
                r.scale(a, a, s), r.add(n.position, n.position, a)
            }
        }, o.prototype.updateNodeNodeForce = function () {
            for (var e = this.nodes.length, t = 0; e > t; t++) {
                var i = this.nodes[t];
                if (this.barnesHutOptimize)this.applyRegionToNodeRepulsion(this._rootRegion, i); else for (var n = t + 1; e > n; n++) {
                    var a = this.nodes[n];
            ...
            var e = r.create();
            return function (t, i) {
                if (t.node)this.applyNodeToNodeRepulsion(t.node, i, !0); else {
                    ...
                    } else for (var o = 0; o < t.nSubRegions; o++)this.applyRegionToNodeRepulsion(t.subRegions[o], i)
                }
            }
            ...
            return function (t, i, n) {
                if (t !== i && (0 !== t.mass || 0 !== i.mass)) {
                    ...
                    if (0 !== a) {
                        var o, s = t.mass + i.mass, l = Math.sqrt(a);
            ...
            var e = r.create(), t = r.create(), i = r.create();
            return function (n, a) {
                var o = n.node1, s = n.node2;
                if (o !== a && s !== a) {
                    ...
                    if (!(0 > h || h > l)) {
                        ...
                        var d = r.dist(i, a.position) - a.size, c = this.edgeToNodeRepulsionFactor(a.mass, Math.max(d, .1), 100);
        ...
        self.onmessage = function (e) {
            if (e.data instanceof ArrayBuffer) {
                ...
                case"update":
                    var s = e.data.steps;
                    if (h) {
                        var i = h.nodes.length, t = new Float32Array(2 * i);
