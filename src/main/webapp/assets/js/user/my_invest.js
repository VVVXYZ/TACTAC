    ...
    $(function () {
        $("#all_project_table").dataTable({
            ...
            "aoColumns": [
                ...
                //{"mData": "project_name", 'sClass': '',"bSortable": false},
        ...
        $("#investing_project_table").dataTable({
            "oLanguage": { // 汉化
                "sProcessing": "正在加载数据...",
                "sLengthMenu": "显示 _MENU_ 条 ",
                "sZeroRecords": "没有您要搜索的内容",
        ...
        $("#recycling_project_table").dataTable({
            "oLanguage": { // 汉化
                "sProcessing": "正在加载数据...",
                "sLengthMenu": "显示 _MENU_ 条 ",
                "sZeroRecords": "没有您要搜索的内容",
        ...
        $("#recycled_project_table").dataTable({
            "oLanguage": { // 汉化
                "sProcessing": "正在加载数据...",
                "sLengthMenu": "显示 _MENU_ 条 ",
                "sZeroRecords": "没有您要搜索的内容",
