...
$(function(){
    $("#rpdRechForm").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "POST",
                url: path+"/admin/fundsmanage/mnlOper/rpdRechargeOper",
                data: {
                ...
                success: function (json) {
                    ...
                    if(success == true){
                        ...
                        bootbox.dialog({
                            message: "<span class='bigger-110 red'>操作失败，请联系管理员！ </span>",
                            buttons:
                            {
                                "success" :
                                {
    ...
    $("#adminAuthForm").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "POST",
                url: path+"/admin/fundsmanage/mnlOper/adminAuth",
                data: {
                ...
                success: function (json) {
                    ...
                    if(success == true){
                        bootbox.dialog({
                            message: "<span class='bigger-110'>管理员密码证成功！</span>",
                            buttons:
                            {
                                "success" :
                                {
                        ...
                        bootbox.dialog({
                            message: "<span class='bigger-110 red'>管理员密码证失败！</span>",
                            buttons:
                            {
                                "success" :
                                {
