...
$("#sendMessage").click(function () {
    ...
    if (ids.length != 0) {
        $.ajax({
            type: "POST",
            url: path + "/admin/loanManage/hxLoanRecord/sendMessage",
            data: {
                'repayId':-1,
                'ids': ids.toString()
            },
                        ...
                        buttons: {
                            "success": {
                                ...
                                "callback": function () {
                                    ...
                                    //jQuery("#grid-table").setGridParam({url:path +"/admin/loanManage/hxLoanRecord/getPndRepayList"}).trigger("reloadGrid");
                                }
                            }
                        }
                    });
