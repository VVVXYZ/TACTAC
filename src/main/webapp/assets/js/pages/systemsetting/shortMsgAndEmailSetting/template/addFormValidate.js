...
$(function(){
    ...
    $("#addForm").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "POST",
                url: path+"/admin/systemSetting/shortMsgAndEmailSetting/createMessageTemplate",
                data: {
                    'templateType': $('input[name="templateType1"]:checked').val(),
                    'templateName': $('#templateName1').val(),
                    'ytxTemplateId': $('#ytxTemplateId1').val(),
                    'templateContent': $('#templateContent1').val()
                },
                dataType: 'json',
                success: function (json) {
                    $("#messageTemplate").dialog("close");
